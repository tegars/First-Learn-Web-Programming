...
<div data-role="page">
  ...
  <div data-role="content">
    <form name="formTambah" id="formTambah" method="post" action="simpan.php" data-ajax="false" enctype="multipart/form-data">
      <div data-role="fieldcontain">
        <label for="nim">NIM:</label>
        <input type="text" name="nim" id="nim" placeholder="Isi NIM Mahasiswa...." required="required" />
      </div>
      <div data-role="fieldcontain">
        <label for="nama">Nama:</label>
        <input type="text" name="nama" id="nama" placeholder="Isi Nama Mahasiswa..." required="required" />
      </div>
      <div data-role="fieldcontain">
        <label for="alamat">Alamat:</label>
        <textarea name="alamat" id="alamat" placeholder="Isi Alamat Mahasiswa..." required="required"></textarea>
      </div>
      <div data-role="fieldcontain">
      ...
      <div data-role="fieldcontain">
        ...
        <input type="text" name="tahun" id="tahun" placeholder="Isi Tahun Masuk..." required="required" />
      </div>
      <div data-role="fieldcontain">
